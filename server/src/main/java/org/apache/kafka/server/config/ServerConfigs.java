...
public class ServerConfigs {
    ...
    public static final ConfigDef CONFIG_DEF =  new ConfigDef()
            .define(BROKER_ID_GENERATION_ENABLE_CONFIG, BOOLEAN, BROKER_ID_GENERATION_ENABLE_DEFAULT, null, MEDIUM, BROKER_ID_GENERATION_ENABLE_DOC,  new ConfigDef.NodeRoles(false, true))
            .define(RESERVED_BROKER_MAX_ID_CONFIG, INT, RESERVED_BROKER_MAX_ID_DEFAULT, atLeast(0), MEDIUM, RESERVED_BROKER_MAX_ID_DOC, new ConfigDef.NodeRoles(true, true))
            ...
            .define(NUM_IO_THREADS_CONFIG, INT, NUM_IO_THREADS_DEFAULT, atLeast(1), HIGH, NUM_IO_THREADS_DOC, new ConfigDef.NodeRoles(true, true))
            .define(NUM_REPLICA_ALTER_LOG_DIRS_THREADS_CONFIG, INT, null, HIGH, NUM_REPLICA_ALTER_LOG_DIRS_THREADS_DOC)
            .define(BACKGROUND_THREADS_CONFIG, INT, BACKGROUND_THREADS_DEFAULT, atLeast(1), HIGH, BACKGROUND_THREADS_DOC, new ConfigDef.NodeRoles(true, true))
            .define(REQUEST_TIMEOUT_MS_CONFIG, INT, REQUEST_TIMEOUT_MS_DEFAULT, HIGH, REQUEST_TIMEOUT_MS_DOC)
            .define(SOCKET_CONNECTION_SETUP_TIMEOUT_MS_CONFIG, LONG, DEFAULT_SOCKET_CONNECTION_SETUP_TIMEOUT_MS, null, MEDIUM, SOCKET_CONNECTION_SETUP_TIMEOUT_MS_DOC, new ConfigDef.NodeRoles(true, true))
            .define(SOCKET_CONNECTION_SETUP_TIMEOUT_MAX_MS_CONFIG, LONG, SOCKET_CONNECTION_SETUP_TIMEOUT_MAX_MS, null, MEDIUM, SOCKET_CONNECTION_SETUP_TIMEOUT_MAX_MS_DOC, new ConfigDef.NodeRoles(true, true))
            /************* Authorizer Configuration ***********/
            .define(AUTHORIZER_CLASS_NAME_CONFIG, STRING, AUTHORIZER_CLASS_NAME_DEFAULT, new ConfigDef.NonNullValidator(), LOW, AUTHORIZER_CLASS_NAME_DOC, new ConfigDef.NodeRoles(true, true))
            .define(EARLY_START_LISTENERS_CONFIG, STRING, null, null, HIGH, EARLY_START_LISTENERS_DOC, new ConfigDef.NodeRoles(true, true))
            /************ Rack Configuration ******************/
            .define(BROKER_RACK_CONFIG, STRING, null, null, MEDIUM, BROKER_RACK_DOC, new ConfigDef.NodeRoles(true, true))
            /** ********* Controlled shutdown configuration ***********/
            .define(CONTROLLED_SHUTDOWN_MAX_RETRIES_CONFIG, INT, CONTROLLED_SHUTDOWN_MAX_RETRIES_DEFAULT, null, MEDIUM, CONTROLLED_SHUTDOWN_MAX_RETRIES_DOC, new ConfigDef.NodeRoles(true, true))
            .define(CONTROLLED_SHUTDOWN_RETRY_BACKOFF_MS_CONFIG, LONG, CONTROLLED_SHUTDOWN_RETRY_BACKOFF_MS_DEFAULT, null, MEDIUM, CONTROLLED_SHUTDOWN_RETRY_BACKOFF_MS_DOC, new ConfigDef.NodeRoles(true, true))
            .define(CONTROLLED_SHUTDOWN_ENABLE_CONFIG, BOOLEAN, CONTROLLED_SHUTDOWN_ENABLE_DEFAULT, null, MEDIUM, CONTROLLED_SHUTDOWN_ENABLE_DOC, new ConfigDef.NodeRoles(true, true))
            .define(DELETE_TOPIC_ENABLE_CONFIG, BOOLEAN, DELETE_TOPIC_ENABLE_DEFAULT, null, HIGH, DELETE_TOPIC_ENABLE_DOC, new ConfigDef.NodeRoles(true, true))
